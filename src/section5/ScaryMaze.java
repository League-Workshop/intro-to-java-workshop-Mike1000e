...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("superFinalMikesMaze.png"));
...
if (mouseColor == finishColor){
			...
			System.out.println("Hurrrraaaay");
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("boosound.wav"));
